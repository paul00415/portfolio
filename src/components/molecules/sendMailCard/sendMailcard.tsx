...
export const SendMailCard = () => {
  return (
    <div className="border-2 border-gray-300 rounded-3xl bg-transparent mt-20">
      <div className=" p-5 sm:p-10 md:p-10 place-content-center">
        <div className="grid grid-cols-1  sm:grid-cols-2 gap-10  ">
          <div className="gird grid-rows-5 sm:grid-rows-3 gap-y-2">
        ...
        <div className="col-span-2 flex justify-center p-5">
          ...
          >
            <Button
              className="bg-green-800 text-gray-200 col-span-2 w-42 p-2"
              label="Send Message"
            />
          </motion.div>
        </div>
