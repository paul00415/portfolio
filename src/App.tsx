...
function App() {
  ...
  const isBigScreen = useMediaQuery('(min-width: 1537px)');
  return (
    <div>
      <div className="h-50vh" style={{ backgroundImage: `url(/back3.jpg)` }}>
        <HomePage />
      </div>
      <div className=" min-h-screen relative 2xl:p-40  flex flex-col 2xl:justify-between 2xl:flex-row items-center gap-0 2xl:gap-40">
